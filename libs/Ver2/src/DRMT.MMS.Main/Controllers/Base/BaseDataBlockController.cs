...
{
  [ApiController]
  [Route("api/v1/BaseDataBlock")]
  public class BaseDataBlockController : BaseCRUDController<DataBlockEntity, DataBlockRequestModel, DataBlockResponseModel>
  {
    protected BaseDataBlockService _serviceBase;

    public BaseDataBlockController(
        BaseDataBlockService service,
        ILogger<BaseDataBlockController> logger
        )
      : base(service, logger)
    {
      _serviceCRUD = service;
      _serviceBase = (BaseDataBlockService)_serviceCRUD;
    }

...
namespace SourceBaseBE.MainService.Services
{
    public class BaseGenTemplateService : BaseCRUDService<GenTemplateEntity>
    {
            ...
            : base(dbContext, logger)
        {
            ...
            _repositoryCRUD = new BaseGenTemplateRepository(dbContext);
            _repositoryBase = (BaseGenTemplateRepository)_repositoryCRUD;
            /*[GEN-2]*/
        }
        public override string GetServiceName()
        {
            return nameof(BaseGenTemplateService);
        }
            ...
            bool isTracking = false)
        {
            ...
            List<GenTemplateResponseModel> listItemResponse = new GenTemplateResponseModel().SetData(list).Cast<GenTemplateResponseModel>().ToList();

            //* get column language
            var columns = new GenTemplateResponseModel().GetColumnAttribute();

            this.TranslateData(columns, request.Lang, nameof(GenTemplateEntity));
            ...
            List<string> translateFields = null)
        {
            ...
            var dicFieldName2Index = new GenTemplateResponseModel().GetColumnAttribute()
        ...
        public override int Delete(GenTemplateEntity entity, long? userId = null, bool isSoftDelete = true)
        {
        ...
        /// <returns></returns>
        public virtual List<long> GetListIdChildren(GenTemplateEntity entity, string childEntity)
        {
            switch (childEntity)
            {
                /*[GEN-5]*/
        ...
        /// <param name="childEntity"></param>
        /// <returns></returns>
        public virtual long? GetItemIdChildren(GenTemplateEntity entity, string childEntity)
        {
            switch (childEntity)
            {
                /*[GEN-45]*/

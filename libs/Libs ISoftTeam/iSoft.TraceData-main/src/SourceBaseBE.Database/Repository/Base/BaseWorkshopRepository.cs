...
{
    public class BaseWorkshopRepository : BaseCRUDRepository<WorkshopEntity>
    {
        public BaseWorkshopRepository(CommonDBContext dbContext)
            : base(dbContext)
        {
        }
        ...
        {
            return nameof(BaseWorkshopRepository);
        }
        public override object GetDisplayField(WorkshopEntity entity)
        {
            return entity.Name;
        ...
        public override WorkshopEntity? GetById(long id, bool isTracking = false)
        {
            try
            {
                WorkshopEntity? result = null;
                var dataSet = _context.Set<WorkshopEntity>();
                IQueryable<WorkshopEntity> queryable;
                if (!isTracking)
                {
                ...
                queryable = queryable
                      .Include(entity => entity.ListLine)
                      .Include(entity => entity.ItemFactory)
                      
                      .Where(entity => entity.DeletedFlag != true && entity.Id == id);

                if (!isTracking)
                {
                    queryable = queryable.Select(entity => new WorkshopEntity()
                    {
                        Id = entity.Id,
                        Order = entity.Order,
                        ...
                        Name = entity.Name,
                        ListLine = entity.ListLine == null ? null : entity.ListLine.Where(x => x.DeletedFlag != true).ToList(),
                ...
                else
                {
                    ...
                    if (entity != null)
                    {
                        entity.ListLine = entity.ListLine == null ? null : entity.ListLine.Where(x => x.DeletedFlag != true).ToList();
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public override List<WorkshopEntity> GetList(PagingRequestModel pagingReq = null, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<WorkshopEntity>? result = null;
                ...
                {
                    result = this.GetRedisData<List<WorkshopEntity>>(cacheKey, null);
                }
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public (List<WorkshopEntity> listWorkshop, long totalRecord) GetListFilter(
            ...
            bool isTracking = false)
        {
            try
            {
                ...
                if (!isDirect && !isTracking)
                {
                    (result, totalRecord) = this.GetRedisData<(List<WorkshopEntity>, long)>(cacheKey, (null, 0));
                }
                ...
                if (result == null)
                {
                    var dataSet = _context.Set<WorkshopEntity>();
                    IQueryable<WorkshopEntity> queryable;
                    IQueryable<WorkshopEntity> queryableCountTotal;
                    if (!isTracking)
                    {
                        queryable = dataSet.AsNoTracking().AsQueryable();
                    }
                    ...
                    var responseModel = new BaseWorkshopResponseModel();
        ...
        public override List<WorkshopEntity> GetListByListIds(List<long> Ids, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<WorkshopEntity>? result = null;
        ...
        public void Upsert(WorkshopEntity entity, List<LineEntity> lineChildren, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
                {
                    // Insert
                    Insert(entity, lineChildren, userId);
                }
                else
                {
                    // Update
                    Update(entity, lineChildren, userId);
                }
                return;
            }
            catch (Exception ex)
        ...
        public void Insert(WorkshopEntity entity, List<LineEntity> lineChildren, long? userId = null)
        {
            try
            {
                if (entity.Id > 0)
                ...
                else
                {
                    ...
                    entity.ListLine = MergeChildrenEntity(entity.ListLine, lineChildren);
                    
                    _context.Set<WorkshopEntity>().Add(entity);
                }
        ...
        public void Update(WorkshopEntity entity, List<LineEntity> lineChildren, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
                ...
                else
                {
                    ...
                    _context.Set<WorkshopEntity>().Update(entity);
                }
                var result = _context.SaveChanges();
                ClearCachedData();
                return;

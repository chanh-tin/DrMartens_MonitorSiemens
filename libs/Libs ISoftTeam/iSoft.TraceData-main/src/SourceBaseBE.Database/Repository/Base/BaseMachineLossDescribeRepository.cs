...
{
    public class BaseMachineLossDescribeRepository : BaseCRUDRepository<MachineLossDescribeEntity>
    {
        public BaseMachineLossDescribeRepository(CommonDBContext dbContext)
            : base(dbContext)
        {
        }
        public override string TableName
        {
            get { return "MachineLossDescribes"; }
        }
        public override string GetName()
        {
            return nameof(BaseMachineLossDescribeRepository);
        }
        public override object GetDisplayField(MachineLossDescribeEntity entity)
        {
        ...
        public override MachineLossDescribeEntity? GetById(long id, bool isTracking = false)
        {
            try
            {
                MachineLossDescribeEntity? result = null;
                var dataSet = _context.Set<MachineLossDescribeEntity>();
                IQueryable<MachineLossDescribeEntity> queryable;
                if (!isTracking)
                {
                ...
                if (!isTracking)
                {
                    queryable = queryable.Select(entity => new MachineLossDescribeEntity()
                    {
                        Id = entity.Id,
                        Order = entity.Order,
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public override List<MachineLossDescribeEntity> GetList(PagingRequestModel pagingReq = null, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<MachineLossDescribeEntity>? result = null;
                ...
                {
                    result = this.GetRedisData<List<MachineLossDescribeEntity>>(cacheKey, null);
                }
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public (List<MachineLossDescribeEntity> listMachineLossDescribe, long totalRecord) GetListFilter(
            ...
            bool isTracking = false)
        {
            try
            {
                ...
                if (!isDirect && !isTracking)
                {
                    (result, totalRecord) = this.GetRedisData<(List<MachineLossDescribeEntity>, long)>(cacheKey, (null, 0));
                }
                ...
                if (result == null)
                {
                    var dataSet = _context.Set<MachineLossDescribeEntity>();
                    IQueryable<MachineLossDescribeEntity> queryable;
                    IQueryable<MachineLossDescribeEntity> queryableCountTotal;
                    if (!isTracking)
                    {
                        queryable = dataSet.AsNoTracking().AsQueryable();
                    }
                    ...
                    var responseModel = new BaseMachineLossDescribeResponseModel();
        ...
        public override List<MachineLossDescribeEntity> GetListByListIds(List<long> Ids, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<MachineLossDescribeEntity>? result = null;
        ...
        public void Upsert(MachineLossDescribeEntity entity, List<MachineBlockDataEntity> machineBlockDataChildren, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
        ...
        public void Insert(MachineLossDescribeEntity entity, List<MachineBlockDataEntity> machineBlockDataChildren, long? userId = null)
        {
            try
            {
                if (entity.Id > 0)
                ...
                else
                {
                    ...
                    _context.Set<MachineLossDescribeEntity>().Add(entity);
                }
        ...
        public void Update(MachineLossDescribeEntity entity, List<MachineBlockDataEntity> machineBlockDataChildren, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
                ...
                else
                {
                    ...
                    _context.Set<MachineLossDescribeEntity>().Update(entity);
                }
                var result = _context.SaveChanges();
                ClearCachedData();
                return;

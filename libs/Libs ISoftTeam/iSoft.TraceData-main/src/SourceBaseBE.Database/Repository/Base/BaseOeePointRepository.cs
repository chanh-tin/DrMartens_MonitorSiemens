...
{
    public class BaseOeePointRepository : BaseCRUDRepository<OeePointEntity>
    {
        public BaseOeePointRepository(CommonDBContext dbContext)
            : base(dbContext)
        {
        }
        public override string TableName
        {
            get { return "OeePoints"; }
        }
        public override string GetName()
        {
            return nameof(BaseOeePointRepository);
        }
        public override object GetDisplayField(OeePointEntity entity)
        {
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public (List<OeePointEntity> listOeePoint, long totalRecord) GetListFilter(
            ...
            bool isTracking = false)
        {
            try
            {
                ...
                if (result == null)
                {
                    ...
                    var responseModel = new BaseOeePointResponseModel();
        ...
        public void Upsert(OeePointEntity entity, List<MachineBlockDataEntity> machineBlockDataChildren, List<MachineEntity> machineChildren, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
                {
                    // Insert
                    Insert(entity, machineBlockDataChildren, machineChildren, userId);
                }
                else
                {
                    // Update
                    Update(entity, machineBlockDataChildren, machineChildren, userId);
                }
                return;
            }
            catch (Exception ex)
        ...
        public void Insert(OeePointEntity entity, List<MachineBlockDataEntity> machineBlockDataChildren, List<MachineEntity> machineChildren, long? userId = null)
        {
            try
            {
                if (entity.Id > 0)
                ...
                else
                {
                    ...
                    _context.Set<OeePointEntity>().Add(entity);
                }
        ...
        public void Update(OeePointEntity entity, List<MachineBlockDataEntity> machineBlockDataChildren, List<MachineEntity> machineChildren, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
                ...
                else
                {
                    ...
                    _context.Set<OeePointEntity>().Update(entity);
                }
                var result = _context.SaveChanges();
                ClearCachedData();
                return;

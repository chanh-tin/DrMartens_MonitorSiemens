...
{
    public class BaseMachineLossGroupRepository : BaseCRUDRepository<MachineLossGroupEntity>
    {
        public BaseMachineLossGroupRepository(CommonDBContext dbContext)
            : base(dbContext)
        {
        }
        public override string TableName
        {
            get { return "MachineLossGroups"; }
        }
        public override string GetName()
        {
            return nameof(BaseMachineLossGroupRepository);
        }
        public override object GetDisplayField(MachineLossGroupEntity entity)
        {
        ...
        public override MachineLossGroupEntity? GetById(long id, bool isTracking = false)
        {
            try
            {
                MachineLossGroupEntity? result = null;
                var dataSet = _context.Set<MachineLossGroupEntity>();
                IQueryable<MachineLossGroupEntity> queryable;
                if (!isTracking)
                {
                ...
                queryable = queryable
                      .Include(entity => entity.ListMachineLoss)
                      
                      .Where(entity => entity.DeletedFlag != true && entity.Id == id);

                if (!isTracking)
                {
                    queryable = queryable.Select(entity => new MachineLossGroupEntity()
                    {
                        Id = entity.Id,
                        Order = entity.Order,
                        ...
                        Note = entity.Note,
                        OeeAPQType = entity.OeeAPQType,
                        ListMachineLoss = entity.ListMachineLoss == null ? null : entity.ListMachineLoss.Where(x => x.DeletedFlag != true).ToList(),
                ...
                else
                {
                    ...
                    if (entity != null)
                    {
                        entity.ListMachineLoss = entity.ListMachineLoss == null ? null : entity.ListMachineLoss.Where(x => x.DeletedFlag != true).ToList();
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public override List<MachineLossGroupEntity> GetList(PagingRequestModel pagingReq = null, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<MachineLossGroupEntity>? result = null;
                ...
                {
                    result = this.GetRedisData<List<MachineLossGroupEntity>>(cacheKey, null);
                }
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public (List<MachineLossGroupEntity> listMachineLossGroup, long totalRecord) GetListFilter(
            ...
            bool isTracking = false)
        {
            try
            {
                ...
                if (!isDirect && !isTracking)
                {
                    (result, totalRecord) = this.GetRedisData<(List<MachineLossGroupEntity>, long)>(cacheKey, (null, 0));
                }
                ...
                if (result == null)
                {
                    var dataSet = _context.Set<MachineLossGroupEntity>();
                    IQueryable<MachineLossGroupEntity> queryable;
                    IQueryable<MachineLossGroupEntity> queryableCountTotal;
                    if (!isTracking)
                    {
                        queryable = dataSet.AsNoTracking().AsQueryable();
                    }
                    ...
                    var responseModel = new BaseMachineLossGroupResponseModel();
        ...
        public override List<MachineLossGroupEntity> GetListByListIds(List<long> Ids, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<MachineLossGroupEntity>? result = null;
        ...
        public void Upsert(MachineLossGroupEntity entity, List<MachineLossEntity> machineLossChildren, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
                {
                    // Insert
                    Insert(entity, machineLossChildren, userId);
                }
                else
                {
                    // Update
                    Update(entity, machineLossChildren, userId);
                }
                return;
            }
            catch (Exception ex)
        ...
        public void Insert(MachineLossGroupEntity entity, List<MachineLossEntity> machineLossChildren, long? userId = null)
        {
            try
            {
                if (entity.Id > 0)
                ...
                else
                {
                    ...
                    entity.ListMachineLoss = MergeChildrenEntity(entity.ListMachineLoss, machineLossChildren);
                    
                    _context.Set<MachineLossGroupEntity>().Add(entity);
                }
        ...
        public void Update(MachineLossGroupEntity entity, List<MachineLossEntity> machineLossChildren, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
                ...
                else
                {
                    ...
                    _context.Set<MachineLossGroupEntity>().Update(entity);
                }
                var result = _context.SaveChanges();
                ClearCachedData();
                return;

...
{
    public class BaseOeePointConfigRepository : BaseCRUDRepository<OeePointConfigEntity>
    {
        public BaseOeePointConfigRepository(CommonDBContext dbContext)
            : base(dbContext)
        {
        }
        public override string TableName
        {
            get { return "OeePointConfigs"; }
        }
        public override string GetName()
        {
            return nameof(BaseOeePointConfigRepository);
        }
        public override object GetDisplayField(OeePointConfigEntity entity)
        {
        ...
        public override OeePointConfigEntity? GetById(long id, bool isTracking = false)
        {
            try
            {
                OeePointConfigEntity? result = null;
                var dataSet = _context.Set<OeePointConfigEntity>();
                IQueryable<OeePointConfigEntity> queryable;
                if (!isTracking)
                {
                ...
                if (!isTracking)
                {
                    queryable = queryable.Select(entity => new OeePointConfigEntity()
                    {
                        Id = entity.Id,
                        Order = entity.Order,
                        ...
                        TotalCountInTag = entity.TotalCountInTag,
                        TotalGoodCountTag = entity.TotalGoodCountTag,
                        TotalNGCountTag = entity.TotalNGCountTag,
                        AvaiableTag = entity.AvaiableTag,
                        PerformanceTag = entity.PerformanceTag,
                        QualityTag = entity.QualityTag,
                        OeeTag = entity.OeeTag,
                        TotalDowntimeTag = entity.TotalDowntimeTag,
                        TotalRunTimeTag = entity.TotalRunTimeTag,
                        OeePointStatusTag = entity.OeePointStatusTag,
                        CurrentDurationTag = entity.CurrentDurationTag,
                        SyncConfigFlag = entity.SyncConfigFlag,
                        OeePointIds = entity.OeePointIds,
                        ListOeePoint = entity.ListOeePoint,
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public override List<OeePointConfigEntity> GetList(PagingRequestModel pagingReq = null, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<OeePointConfigEntity>? result = null;
                ...
                {
                    result = this.GetRedisData<List<OeePointConfigEntity>>(cacheKey, null);
                }
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public (List<OeePointConfigEntity> listOeePointConfig, long totalRecord) GetListFilter(
            ...
            bool isTracking = false)
        {
            try
            {
                ...
                if (!isDirect && !isTracking)
                {
                    (result, totalRecord) = this.GetRedisData<(List<OeePointConfigEntity>, long)>(cacheKey, (null, 0));
                }
                ...
                if (result == null)
                {
                    var dataSet = _context.Set<OeePointConfigEntity>();
                    IQueryable<OeePointConfigEntity> queryable;
                    IQueryable<OeePointConfigEntity> queryableCountTotal;
                    if (!isTracking)
                    {
                        queryable = dataSet.AsNoTracking().AsQueryable();
                    }
                    ...
                    var responseModel = new BaseOeePointConfigResponseModel();
        ...
        public override List<OeePointConfigEntity> GetListByListIds(List<long> Ids, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<OeePointConfigEntity>? result = null;
        ...
        public void Upsert(OeePointConfigEntity entity, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
        ...
        public void Insert(OeePointConfigEntity entity, long? userId = null)
        {
            try
            {
                if (entity.Id > 0)
                ...
                else
                {
                    ...
                    _context.Set<OeePointConfigEntity>().Add(entity);
                }
        ...
        public void Update(OeePointConfigEntity entity, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)

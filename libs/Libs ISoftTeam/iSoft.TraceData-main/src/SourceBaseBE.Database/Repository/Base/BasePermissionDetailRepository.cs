...
{
    public class BasePermissionDetailRepository : BaseCRUDRepository<PermissionDetailEntity>
    {
        public BasePermissionDetailRepository(CommonDBContext dbContext)
            : base(dbContext)
        {
        }
        ...
        {
            return nameof(BasePermissionDetailRepository);
        }
        public override object GetDisplayField(PermissionDetailEntity entity)
        {
            return entity.PermissionTable;
        ...
        public override PermissionDetailEntity? GetById(long id, bool isTracking = false)
        {
            try
            {
                PermissionDetailEntity? result = null;
                var dataSet = _context.Set<PermissionDetailEntity>();
                IQueryable<PermissionDetailEntity> queryable;
                if (!isTracking)
                {
                ...
                queryable = queryable
                      .Include(entity => entity.ItemPermission)
                      
                      .Where(entity => entity.DeletedFlag != true && entity.Id == id);

                if (!isTracking)
                {
                    queryable = queryable.Select(entity => new PermissionDetailEntity()
                    {
                        Id = entity.Id,
                        Order = entity.Order,
                        ...
                        ItemPermission = entity.ItemPermission,
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public override List<PermissionDetailEntity> GetList(PagingRequestModel pagingReq = null, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<PermissionDetailEntity>? result = null;
                ...
                {
                    result = this.GetRedisData<List<PermissionDetailEntity>>(cacheKey, null);
                }
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public (List<PermissionDetailEntity> listPermissionDetail, long totalRecord) GetListFilter(
            ...
            bool isTracking = false)
        {
            try
            {
                ...
                if (!isDirect && !isTracking)
                {
                    (result, totalRecord) = this.GetRedisData<(List<PermissionDetailEntity>, long)>(cacheKey, (null, 0));
                }
                ...
                if (result == null)
                {
                    var dataSet = _context.Set<PermissionDetailEntity>();
                    IQueryable<PermissionDetailEntity> queryable;
                    IQueryable<PermissionDetailEntity> queryableCountTotal;
                    if (!isTracking)
                    {
                        queryable = dataSet.AsNoTracking().AsQueryable();
                    }
                    ...
                    var responseModel = new BasePermissionDetailResponseModel();
        ...
        public override List<PermissionDetailEntity> GetListByListIds(List<long> Ids, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<PermissionDetailEntity>? result = null;
        ...
        public void Upsert(PermissionDetailEntity entity, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
        ...
        public void Insert(PermissionDetailEntity entity, long? userId = null)
        {
            try
            {
                if (entity.Id > 0)
                ...
                else
                {
                    ...
                    _context.Set<PermissionDetailEntity>().Add(entity);
                }
        ...
        public void Update(PermissionDetailEntity entity, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
                ...
                else
                {
                    ...
                    _context.Set<PermissionDetailEntity>().Update(entity);
                }
                var result = _context.SaveChanges();
                ClearCachedData();
                return;

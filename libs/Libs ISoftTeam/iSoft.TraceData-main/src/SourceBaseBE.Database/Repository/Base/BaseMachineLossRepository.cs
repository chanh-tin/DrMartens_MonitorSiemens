...
{
    public class BaseMachineLossRepository : BaseCRUDRepository<MachineLossEntity>
    {
        public BaseMachineLossRepository(CommonDBContext dbContext)
            : base(dbContext)
        {
        }
        public override string TableName
        {
            get { return "MachineLosses"; }
        }
        public override string GetName()
        {
            return nameof(BaseMachineLossRepository);
        }
        public override object GetDisplayField(MachineLossEntity entity)
        {
        ...
        public override MachineLossEntity? GetById(long id, bool isTracking = false)
        {
            try
            {
                MachineLossEntity? result = null;
                var dataSet = _context.Set<MachineLossEntity>();
                IQueryable<MachineLossEntity> queryable;
                if (!isTracking)
                {
                ...
                queryable = queryable
                      ...
                      .Include(entity => entity.ItemMachineLossGroup)
                      
                      .Where(entity => entity.DeletedFlag != true && entity.Id == id);

                if (!isTracking)
                {
                    queryable = queryable.Select(entity => new MachineLossEntity()
                    {
                        Id = entity.Id,
                        Order = entity.Order,
                        ...
                        MachineLossGroupId = entity.MachineLossGroupId,
                        ItemMachineLossGroup = entity.ItemMachineLossGroup,
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public override List<MachineLossEntity> GetList(PagingRequestModel pagingReq = null, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<MachineLossEntity>? result = null;
                ...
                {
                    result = this.GetRedisData<List<MachineLossEntity>>(cacheKey, null);
                }
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public (List<MachineLossEntity> listMachineLoss, long totalRecord) GetListFilter(
            ...
            bool isTracking = false)
        {
            try
            {
                ...
                if (!isDirect && !isTracking)
                {
                    (result, totalRecord) = this.GetRedisData<(List<MachineLossEntity>, long)>(cacheKey, (null, 0));
                }
                ...
                if (result == null)
                {
                    var dataSet = _context.Set<MachineLossEntity>();
                    IQueryable<MachineLossEntity> queryable;
                    IQueryable<MachineLossEntity> queryableCountTotal;
                    if (!isTracking)
                    {
                        queryable = dataSet.AsNoTracking().AsQueryable();
                    }
                    ...
                    var responseModel = new BaseMachineLossResponseModel();
        ...
        public override List<MachineLossEntity> GetListByListIds(List<long> Ids, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<MachineLossEntity>? result = null;
        ...
        public void Upsert(MachineLossEntity entity, List<MachineBlockDataEntity> machineBlockDataChildren, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
        ...
        public void Insert(MachineLossEntity entity, List<MachineBlockDataEntity> machineBlockDataChildren, long? userId = null)
        {
            try
            {
                if (entity.Id > 0)
                ...
                else
                {
                    ...
                    _context.Set<MachineLossEntity>().Add(entity);
                }
        ...
        public void Update(MachineLossEntity entity, List<MachineBlockDataEntity> machineBlockDataChildren, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
                ...
                else
                {
                    ...
                    _context.Set<MachineLossEntity>().Update(entity);
                }
                var result = _context.SaveChanges();
                ClearCachedData();
                return;

...
{
    public class BaseTranslateLanguageRepository : BaseCRUDRepository<TranslateLanguageEntity>
    {
        public BaseTranslateLanguageRepository(CommonDBContext dbContext)
            : base(dbContext)
        {
        }
        ...
        {
            return nameof(BaseTranslateLanguageRepository);
        }
        public override object GetDisplayField(TranslateLanguageEntity entity)
        {
            return entity.Key;
        ...
        public override TranslateLanguageEntity? GetById(long id, bool isTracking = false)
        {
            try
            {
                TranslateLanguageEntity? result = null;
                var dataSet = _context.Set<TranslateLanguageEntity>();
                IQueryable<TranslateLanguageEntity> queryable;
                if (!isTracking)
                {
                ...
                if (!isTracking)
                {
                    queryable = queryable.Select(entity => new TranslateLanguageEntity()
                    {
                        Id = entity.Id,
                        Order = entity.Order,
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public override List<TranslateLanguageEntity> GetList(PagingRequestModel pagingReq = null, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<TranslateLanguageEntity>? result = null;
                ...
                {
                    result = this.GetRedisData<List<TranslateLanguageEntity>>(cacheKey, null);
                }
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public (List<TranslateLanguageEntity> listTranslateLanguage, long totalRecord) GetListFilter(
            ...
            bool isTracking = false)
        {
            try
            {
                ...
                if (!isDirect && !isTracking)
                {
                    (result, totalRecord) = this.GetRedisData<(List<TranslateLanguageEntity>, long)>(cacheKey, (null, 0));
                }
                ...
                if (result == null)
                {
                    var dataSet = _context.Set<TranslateLanguageEntity>();
                    IQueryable<TranslateLanguageEntity> queryable;
                    IQueryable<TranslateLanguageEntity> queryableCountTotal;
                    if (!isTracking)
                    {
                        queryable = dataSet.AsNoTracking().AsQueryable();
                    }
                    ...
                    var responseModel = new BaseTranslateLanguageResponseModel();
        ...
        public override List<TranslateLanguageEntity> GetListByListIds(List<long> Ids, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<TranslateLanguageEntity>? result = null;
        ...
        public void Upsert(TranslateLanguageEntity entity, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
        ...
        public void Insert(TranslateLanguageEntity entity, long? userId = null)
        {
            try
            {
                if (entity.Id > 0)
                ...
                else
                {
                    ...
                    _context.Set<TranslateLanguageEntity>().Add(entity);
                }
        ...
        public void Update(TranslateLanguageEntity entity, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
                ...
                else
                {
                    ...
                    _context.Set<TranslateLanguageEntity>().Update(entity);
                }
                var result = _context.SaveChanges();
                ClearCachedData();
                return;

...
{
    public class BaseFactoryRepository : BaseCRUDRepository<FactoryEntity>
    {
        public BaseFactoryRepository(CommonDBContext dbContext)
            : base(dbContext)
        {
        }
        ...
        {
            return nameof(BaseFactoryRepository);
        }
        public override object GetDisplayField(FactoryEntity entity)
        {
            return entity.Name;
        ...
        public override FactoryEntity? GetById(long id, bool isTracking = false)
        {
            try
            {
                FactoryEntity? result = null;
                var dataSet = _context.Set<FactoryEntity>();
                IQueryable<FactoryEntity> queryable;
                if (!isTracking)
                {
                ...
                queryable = queryable
                      .Include(entity => entity.ListWorkshop)
                      
                      .Where(entity => entity.DeletedFlag != true && entity.Id == id);

                if (!isTracking)
                {
                    queryable = queryable.Select(entity => new FactoryEntity()
                    {
                        Id = entity.Id,
                        Order = entity.Order,
                        ...
                        Name = entity.Name,
                        ListWorkshop = entity.ListWorkshop == null ? null : entity.ListWorkshop.Where(x => x.DeletedFlag != true).ToList(),
                ...
                else
                {
                    ...
                    if (entity != null)
                    {
                        entity.ListWorkshop = entity.ListWorkshop == null ? null : entity.ListWorkshop.Where(x => x.DeletedFlag != true).ToList();
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public override List<FactoryEntity> GetList(PagingRequestModel pagingReq = null, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<FactoryEntity>? result = null;
                ...
                {
                    result = this.GetRedisData<List<FactoryEntity>>(cacheKey, null);
                }
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public (List<FactoryEntity> listFactory, long totalRecord) GetListFilter(
            ...
            bool isTracking = false)
        {
            try
            {
                ...
                if (!isDirect && !isTracking)
                {
                    (result, totalRecord) = this.GetRedisData<(List<FactoryEntity>, long)>(cacheKey, (null, 0));
                }
                ...
                if (result == null)
                {
                    var dataSet = _context.Set<FactoryEntity>();
                    IQueryable<FactoryEntity> queryable;
                    IQueryable<FactoryEntity> queryableCountTotal;
                    if (!isTracking)
                    {
                        queryable = dataSet.AsNoTracking().AsQueryable();
                    }
                    ...
                    var responseModel = new BaseFactoryResponseModel();
        ...
        public override List<FactoryEntity> GetListByListIds(List<long> Ids, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<FactoryEntity>? result = null;
        ...
        public void Upsert(FactoryEntity entity, List<WorkshopEntity> workshopChildren, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
                {
                    // Insert
                    Insert(entity, workshopChildren, userId);
                }
                else
                {
                    // Update
                    Update(entity, workshopChildren, userId);
                }
                return;
            }
            catch (Exception ex)
        ...
        public void Insert(FactoryEntity entity, List<WorkshopEntity> workshopChildren, long? userId = null)
        {
            try
            {
                if (entity.Id > 0)
                ...
                else
                {
                    ...
                    entity.ListWorkshop = MergeChildrenEntity(entity.ListWorkshop, workshopChildren);
                    
                    _context.Set<FactoryEntity>().Add(entity);
                }
        ...
        public void Update(FactoryEntity entity, List<WorkshopEntity> workshopChildren, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
                ...
                else
                {
                    ...
                    _context.Set<FactoryEntity>().Update(entity);
                }
                var result = _context.SaveChanges();
                ClearCachedData();
                return;

...
{
    public class BaseShiftRepository : BaseCRUDRepository<ShiftEntity>
    {
        public BaseShiftRepository(CommonDBContext dbContext)
            : base(dbContext)
        {
        }
        ...
        {
            return nameof(BaseShiftRepository);
        }
        public override object GetDisplayField(ShiftEntity entity)
        {
        ...
        public override ShiftEntity? GetById(long id, bool isTracking = false)
        {
            try
            {
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public override List<ShiftEntity> GetList(PagingRequestModel pagingReq = null, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<ShiftEntity>? result = null;
                ...
                {
                    result = this.GetRedisData<List<ShiftEntity>>(cacheKey, null);
                }
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public (List<ShiftEntity> listShift, long totalRecord) GetListFilter(
            ...
            bool isTracking = false)
        {
            try
            {
                ...
                if (!isDirect && !isTracking)
                {
                    (result, totalRecord) = this.GetRedisData<(List<ShiftEntity>, long)>(cacheKey, (null, 0));
                }
                ...
                if (result == null)
                {
                    var dataSet = _context.Set<ShiftEntity>();
                    IQueryable<ShiftEntity> queryable;
                    IQueryable<ShiftEntity> queryableCountTotal;
                    if (!isTracking)
                    {
                        queryable = dataSet.AsNoTracking().AsQueryable();
                    }
                    ...
                    var responseModel = new BaseShiftResponseModel();
        ...
        public override List<ShiftEntity> GetListByListIds(List<long> Ids, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<ShiftEntity>? result = null;
        ...
        public void Upsert(ShiftEntity entity, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
        ...
        public void Insert(ShiftEntity entity, long? userId = null)
        {
            try
            {
                if (entity.Id > 0)
                ...
                else
                {
                    ...
                    _context.Set<ShiftEntity>().Add(entity);
                }
        ...
        public void Update(ShiftEntity entity, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
                ...
                else
                {
                    ...
                    _context.Set<ShiftEntity>().Update(entity);
                }
                var result = _context.SaveChanges();
                ClearCachedData();
                return;

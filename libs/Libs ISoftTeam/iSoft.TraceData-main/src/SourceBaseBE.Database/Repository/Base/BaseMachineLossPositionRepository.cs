...
{
    public class BaseMachineLossPositionRepository : BaseCRUDRepository<MachineLossPositionEntity>
    {
        public BaseMachineLossPositionRepository(CommonDBContext dbContext)
            : base(dbContext)
        {
        }
        public override string TableName
        {
            get { return "MachineLossPositions"; }
        }
        public override string GetName()
        {
            return nameof(BaseMachineLossPositionRepository);
        }
        public override object GetDisplayField(MachineLossPositionEntity entity)
        {
        ...
        public override MachineLossPositionEntity? GetById(long id, bool isTracking = false)
        {
            try
            {
                MachineLossPositionEntity? result = null;
                var dataSet = _context.Set<MachineLossPositionEntity>();
                IQueryable<MachineLossPositionEntity> queryable;
                if (!isTracking)
                {
                ...
                if (!isTracking)
                {
                    queryable = queryable.Select(entity => new MachineLossPositionEntity()
                    {
                        Id = entity.Id,
                        Order = entity.Order,
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public override List<MachineLossPositionEntity> GetList(PagingRequestModel pagingReq = null, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<MachineLossPositionEntity>? result = null;
                ...
                {
                    result = this.GetRedisData<List<MachineLossPositionEntity>>(cacheKey, null);
                }
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public (List<MachineLossPositionEntity> listMachineLossPosition, long totalRecord) GetListFilter(
            ...
            bool isTracking = false)
        {
            try
            {
                ...
                if (!isDirect && !isTracking)
                {
                    (result, totalRecord) = this.GetRedisData<(List<MachineLossPositionEntity>, long)>(cacheKey, (null, 0));
                }
                ...
                if (result == null)
                {
                    var dataSet = _context.Set<MachineLossPositionEntity>();
                    IQueryable<MachineLossPositionEntity> queryable;
                    IQueryable<MachineLossPositionEntity> queryableCountTotal;
                    if (!isTracking)
                    {
                        queryable = dataSet.AsNoTracking().AsQueryable();
                    }
                    ...
                    var responseModel = new BaseMachineLossPositionResponseModel();
        ...
        public override List<MachineLossPositionEntity> GetListByListIds(List<long> Ids, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<MachineLossPositionEntity>? result = null;
        ...
        public void Upsert(MachineLossPositionEntity entity, List<MachineBlockDataEntity> machineBlockDataChildren, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
                {
                    // Insert
                    Insert(entity, machineBlockDataChildren, userId);
                }
                else
                {
                    // Update
                    Update(entity, machineBlockDataChildren, userId);
                }
                return;
            }
            catch (Exception ex)
        ...
        public void Insert(MachineLossPositionEntity entity, List<MachineBlockDataEntity> machineBlockDataChildren, long? userId = null)
        {
            try
            {
                if (entity.Id > 0)
                ...
                else
                {
                    ...
                    entity.ListMachineBlockData = MergeChildrenEntity(entity.ListMachineBlockData, machineBlockDataChildren);
                    
                    _context.Set<MachineLossPositionEntity>().Add(entity);
                }
        ...
        public void Update(MachineLossPositionEntity entity, List<MachineBlockDataEntity> machineBlockDataChildren, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
                ...
                else
                {
                    ...
                    _context.Set<MachineLossPositionEntity>().Update(entity);
                }
                var result = _context.SaveChanges();
                ClearCachedData();
                return;

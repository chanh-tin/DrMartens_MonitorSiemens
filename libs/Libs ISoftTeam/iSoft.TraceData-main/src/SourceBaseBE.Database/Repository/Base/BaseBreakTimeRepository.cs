...
{
    public class BaseBreakTimeRepository : BaseCRUDRepository<BreakTimeEntity>
    {
        public BaseBreakTimeRepository(CommonDBContext dbContext)
            : base(dbContext)
        {
        }
        public override string TableName
        {
            get { return "BreakTimes"; }
        }
        public override string GetName()
        {
            return nameof(BaseBreakTimeRepository);
        }
        public override object GetDisplayField(BreakTimeEntity entity)
        {
        ...
        public override BreakTimeEntity? GetById(long id, bool isTracking = false)
        {
            try
            {
                BreakTimeEntity? result = null;
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public override List<BreakTimeEntity> GetList(PagingRequestModel pagingReq = null, bool isDirect = false, bool isTracking = false)
        {
            try
            {
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public (List<BreakTimeEntity> listBreakTime, long totalRecord) GetListFilter(
            ...
            bool isTracking = false)
        {
            try
            {
                ...
                if (!isDirect && !isTracking)
                {
                    (result, totalRecord) = this.GetRedisData<(List<BreakTimeEntity>, long)>(cacheKey, (null, 0));
                }
                ...
                if (result == null)
                {
                    var dataSet = _context.Set<BreakTimeEntity>();
                    IQueryable<BreakTimeEntity> queryable;
                    IQueryable<BreakTimeEntity> queryableCountTotal;
                    if (!isTracking)
                    {
                        queryable = dataSet.AsNoTracking().AsQueryable();
                    }
                    ...
                    var responseModel = new BaseBreakTimeResponseModel();
        ...
        public override List<BreakTimeEntity> GetListByListIds(List<long> Ids, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<BreakTimeEntity>? result = null;
        ...
        public void Upsert(BreakTimeEntity entity, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
        ...
        public void Insert(BreakTimeEntity entity, long? userId = null)
        {
            try
            {
                if (entity.Id > 0)
                ...
                else
                {
                    ...
                    _context.Set<BreakTimeEntity>().Add(entity);
                }
        ...
        public void Update(BreakTimeEntity entity, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
                ...
                else
                {
                    ...
                    _context.Set<BreakTimeEntity>().Update(entity);
                }
                var result = _context.SaveChanges();
                ClearCachedData();
                return;

...
{
    public class BaseFrontendDataRepository : BaseCRUDRepository<FrontendDataEntity>
    {
        public BaseFrontendDataRepository(CommonDBContext dbContext)
            : base(dbContext)
        {
        }
        public override string TableName
        {
            get { return "FrontendDatas"; }
        }
        public override string GetName()
        {
            return nameof(BaseFrontendDataRepository);
        }
        public override object GetDisplayField(FrontendDataEntity entity)
        {
            return entity.Key;
        ...
        public override FrontendDataEntity? GetById(long id, bool isTracking = false)
        {
            try
            {
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public override List<FrontendDataEntity> GetList(PagingRequestModel pagingReq = null, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<FrontendDataEntity>? result = null;
                ...
                {
                    result = this.GetRedisData<List<FrontendDataEntity>>(cacheKey, null);
                }
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public (List<FrontendDataEntity> listFrontendData, long totalRecord) GetListFilter(
            ...
            bool isTracking = false)
        {
            try
            {
                ...
                if (!isDirect && !isTracking)
                {
                    (result, totalRecord) = this.GetRedisData<(List<FrontendDataEntity>, long)>(cacheKey, (null, 0));
                }
                ...
                if (result == null)
                {
                    var dataSet = _context.Set<FrontendDataEntity>();
                    IQueryable<FrontendDataEntity> queryable;
                    IQueryable<FrontendDataEntity> queryableCountTotal;
                    if (!isTracking)
                    {
                        queryable = dataSet.AsNoTracking().AsQueryable();
                    }
                    ...
                    var responseModel = new BaseFrontendDataResponseModel();
        ...
        public override List<FrontendDataEntity> GetListByListIds(List<long> Ids, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<FrontendDataEntity>? result = null;
        ...
        public void Upsert(FrontendDataEntity entity, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
        ...
        public void Insert(FrontendDataEntity entity, long? userId = null)
        {
            try
            {
                if (entity.Id > 0)
                ...
                else
                {
                    ...
                    _context.Set<FrontendDataEntity>().Add(entity);
                }
        ...
        public void Update(FrontendDataEntity entity, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
                ...
                else
                {
                    ...
                    _context.Set<FrontendDataEntity>().Update(entity);
                }
                var result = _context.SaveChanges();
                ClearCachedData();
                return;

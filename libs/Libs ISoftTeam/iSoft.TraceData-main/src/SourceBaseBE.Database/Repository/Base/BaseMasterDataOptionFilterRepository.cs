...
{
    public class BaseMasterDataOptionFilterRepository : BaseCRUDRepository<MasterDataOptionFilterEntity>
    {
        public BaseMasterDataOptionFilterRepository(CommonDBContext dbContext)
            : base(dbContext)
        {
        }
        public override string TableName
        {
            get { return "MasterDataOptionFilters"; }
        }
        public override string GetName()
        {
            return nameof(BaseMasterDataOptionFilterRepository);
        }
        public override object GetDisplayField(MasterDataOptionFilterEntity entity)
        {
        ...
        public override MasterDataOptionFilterEntity? GetById(long id, bool isTracking = false)
        {
            try
            {
                MasterDataOptionFilterEntity? result = null;
                var dataSet = _context.Set<MasterDataOptionFilterEntity>();
                IQueryable<MasterDataOptionFilterEntity> queryable;
                if (!isTracking)
                {
                ...
                if (!isTracking)
                {
                    queryable = queryable.Select(entity => new MasterDataOptionFilterEntity()
                    {
                        Id = entity.Id,
                        Order = entity.Order,
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public override List<MasterDataOptionFilterEntity> GetList(PagingRequestModel pagingReq = null, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<MasterDataOptionFilterEntity>? result = null;
                ...
                {
                    result = this.GetRedisData<List<MasterDataOptionFilterEntity>>(cacheKey, null);
                }
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public (List<MasterDataOptionFilterEntity> listMasterDataOptionFilter, long totalRecord) GetListFilter(
            ...
            bool isTracking = false)
        {
            try
            {
                ...
                if (!isDirect && !isTracking)
                {
                    (result, totalRecord) = this.GetRedisData<(List<MasterDataOptionFilterEntity>, long)>(cacheKey, (null, 0));
                }
                ...
                if (result == null)
                {
                    var dataSet = _context.Set<MasterDataOptionFilterEntity>();
                    IQueryable<MasterDataOptionFilterEntity> queryable;
                    IQueryable<MasterDataOptionFilterEntity> queryableCountTotal;
                    if (!isTracking)
                    {
                        queryable = dataSet.AsNoTracking().AsQueryable();
                    }
                    ...
                    var responseModel = new BaseMasterDataOptionFilterResponseModel();
        ...
        public override List<MasterDataOptionFilterEntity> GetListByListIds(List<long> Ids, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<MasterDataOptionFilterEntity>? result = null;
        ...
        public void Upsert(MasterDataOptionFilterEntity entity, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
        ...
        public void Insert(MasterDataOptionFilterEntity entity, long? userId = null)
        {
            try
            {
                if (entity.Id > 0)
                ...
                else
                {
                    ...
                    _context.Set<MasterDataOptionFilterEntity>().Add(entity);
                }
        ...
        public void Update(MasterDataOptionFilterEntity entity, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
                ...
                else
                {
                    ...
                    _context.Set<MasterDataOptionFilterEntity>().Update(entity);
                }
                var result = _context.SaveChanges();
                ClearCachedData();
                return;

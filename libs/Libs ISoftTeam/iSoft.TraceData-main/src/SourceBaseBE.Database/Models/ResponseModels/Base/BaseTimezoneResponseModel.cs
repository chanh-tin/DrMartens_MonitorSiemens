...
{
    public class BaseTimezoneResponseModel : BaseCRUDResponseModel<TimezoneEntity>
    {
        public virtual string Name { get; set; }
        public virtual int? Timezone { get; set; }
        public virtual List<CountryEntity>? ListCountry { get; set; }
        
        public override object SetData(TimezoneEntity entity)
        {
            base.SetData(entity);
        ...
        public override List<object> SetData(List<TimezoneEntity> listEntity)
        {
            List<Object> listRS = new List<object>();
            foreach (TimezoneEntity entity in listEntity)
            {
                listRS.Add(new BaseTimezoneResponseModel().SetData(entity));
            }
            return listRS;
        }
        public IQueryable<TimezoneEntity> PrepareWhereQueryFilter(
            IQueryable<TimezoneEntity> query,
        ...
        public IQueryable<TimezoneEntity> PrepareQuerySort(
            IQueryable<TimezoneEntity> query,
        ...
        public IQueryable<TimezoneEntity> PrepareWhereQuerySearch(
            IQueryable<TimezoneEntity> query,
            ...
            Type responseType)
        {
            ...
            var predicate = LinqKit.PredicateBuilder.New<TimezoneEntity>(true);
        ...
        public virtual ExpressionStarter<TimezoneEntity> GetPredicate(ExpressionStarter<TimezoneEntity> predicate, string inputFieldKey, string searchValue)
        {
            if (inputFieldKey == nameof(BaseTimezoneResponseModel.Id))
            {
                predicate = predicate.Or(x => EF.Functions.Unaccent(x.Id.ToString().ToLower()).Contains(EF.Functions.Unaccent($"{searchValue.ToLower()}")));
            }
            else if (inputFieldKey == nameof(BaseTimezoneResponseModel.Order))
            {
        ...
        public virtual Dictionary<string, string> GetFieldAttributes()
        {
            ...
            dic.Add(nameof(BaseTimezoneResponseModel.Name), typeof(string).ToString());
            dic.Add(nameof(BaseTimezoneResponseModel.Timezone), typeof(int).ToString());
        ...
        public virtual List<ColumnResponseModel> GetColumnAttribute()
        {
            ...
            columns.Add(new ColumnResponseModel(
                nameof(BaseTimezoneResponseModel.Id),
                nameof(BaseTimezoneResponseModel.Id),
                true, true, true
                ));

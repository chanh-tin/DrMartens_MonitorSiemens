...
{
    public class BaseFactoryResponseModel : BaseCRUDResponseModel<FactoryEntity>
    {
        public virtual string Name { get; set; }
        public virtual List<WorkshopEntity>? ListWorkshop { get; set; }
        
        public override object SetData(FactoryEntity entity)
        {
            base.SetData(entity);
            this.Name = entity.Name;
            if (entity.ListWorkshop != null)
            {
                this.ListWorkshop = entity.ListWorkshop.Select(x => x).ToList();
            }
        
            return this;
        }
        public override List<object> SetData(List<FactoryEntity> listEntity)
        {
            List<Object> listRS = new List<object>();
            foreach (FactoryEntity entity in listEntity)
            {
                listRS.Add(new BaseFactoryResponseModel().SetData(entity));
            }
            return listRS;
        }
        public IQueryable<FactoryEntity> PrepareWhereQueryFilter(
            IQueryable<FactoryEntity> query,
        ...
        public IQueryable<FactoryEntity> PrepareQuerySort(
            IQueryable<FactoryEntity> query,
        ...
        public IQueryable<FactoryEntity> PrepareWhereQuerySearch(
            IQueryable<FactoryEntity> query,
            ...
            Type responseType)
        {
            ...
            var predicate = LinqKit.PredicateBuilder.New<FactoryEntity>(true);
        ...
        public virtual ExpressionStarter<FactoryEntity> GetPredicate(ExpressionStarter<FactoryEntity> predicate, string inputFieldKey, string searchValue)
        {
            if (inputFieldKey == nameof(BaseFactoryResponseModel.Id))
            {
                predicate = predicate.Or(x => EF.Functions.Unaccent(x.Id.ToString().ToLower()).Contains(EF.Functions.Unaccent($"{searchValue.ToLower()}")));
            }
            else if (inputFieldKey == nameof(BaseFactoryResponseModel.Order))
            {
        ...
        public virtual Dictionary<string, string> GetFieldAttributes()
        {
            ...
            dic.Add(nameof(BaseFactoryResponseModel.Name), typeof(string).ToString());
        ...
        public virtual List<ColumnResponseModel> GetColumnAttribute()
        {
            ...
            columns.Add(new ColumnResponseModel(
                nameof(BaseFactoryResponseModel.Id),
                nameof(BaseFactoryResponseModel.Id),
                true, true, true
                ));

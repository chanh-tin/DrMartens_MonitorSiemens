...
{
    public class BasePermissionResponseModel : BaseCRUDResponseModel<PermissionEntity>
    {
        public virtual string? Name { get; set; }
        public virtual string? Description { get; set; }
        public virtual bool? EnabledFlag { get; set; }
        public virtual List<PermissionDetailEntity>? ListPermissionDetail { get; set; }
        public virtual List<UserEntity>? ListUser { get; set; }
        public virtual List<UserGroupEntity>? ListUserGroup { get; set; }
        
        public override object SetData(PermissionEntity entity)
        {
            base.SetData(entity);
            this.Name = entity.Name;
            this.Description = entity.Description;
            this.EnabledFlag = entity.EnabledFlag;
            if (entity.ListPermissionDetail != null)
            {
                this.ListPermissionDetail = entity.ListPermissionDetail.Select(x => x).ToList();
            }
        ...
        public override List<object> SetData(List<PermissionEntity> listEntity)
        {
            List<Object> listRS = new List<object>();
            foreach (PermissionEntity entity in listEntity)
            {
                listRS.Add(new BasePermissionResponseModel().SetData(entity));
            }
            return listRS;
        }
        public IQueryable<PermissionEntity> PrepareWhereQueryFilter(
        ...
        public IQueryable<PermissionEntity> PrepareQuerySort(
            IQueryable<PermissionEntity> query,
        ...
        public IQueryable<PermissionEntity> PrepareWhereQuerySearch(
            IQueryable<PermissionEntity> query,
            ...
            Type responseType)
        {
            ...
            var predicate = LinqKit.PredicateBuilder.New<PermissionEntity>(true);
        ...
        public virtual ExpressionStarter<PermissionEntity> GetPredicate(ExpressionStarter<PermissionEntity> predicate, string inputFieldKey, string searchValue)
        {
            if (inputFieldKey == nameof(BasePermissionResponseModel.Id))
            {
                predicate = predicate.Or(x => EF.Functions.Unaccent(x.Id.ToString().ToLower()).Contains(EF.Functions.Unaccent($"{searchValue.ToLower()}")));
            }
            else if (inputFieldKey == nameof(BasePermissionResponseModel.Order))
            {
        ...
        public virtual Dictionary<string, string> GetFieldAttributes()
        {
            ...
            dic.Add(nameof(BasePermissionResponseModel.Name), typeof(string).ToString());
            dic.Add(nameof(BasePermissionResponseModel.EnabledFlag), typeof(bool).ToString());
        ...
        public virtual List<ColumnResponseModel> GetColumnAttribute()
        {
            ...
            columns.Add(new ColumnResponseModel(
                nameof(BasePermissionResponseModel.Id),
                nameof(BasePermissionResponseModel.Id),
                true, true, true
                ));

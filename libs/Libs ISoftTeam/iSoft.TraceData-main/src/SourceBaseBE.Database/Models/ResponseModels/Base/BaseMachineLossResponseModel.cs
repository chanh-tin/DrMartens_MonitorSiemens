...
{
    public class BaseMachineLossResponseModel : BaseCRUDResponseModel<MachineLossEntity>
    {
        ...
        public virtual MachineLossGroupEntity? ItemMachineLossGroup { get; set; }
        
        public override object SetData(MachineLossEntity entity)
        {
            base.SetData(entity);
            this.Name = entity.Name;
            this.LossReason = entity.LossReason;
            ...
            this.MachineLossGroupId = entity.MachineLossGroupId;
            this.ItemMachineLossGroup = entity.ItemMachineLossGroup;
        ...
        public virtual ExpressionStarter<MachineLossEntity> GetPredicate(ExpressionStarter<MachineLossEntity> predicate, string inputFieldKey, string searchValue)
        {
        ...
        public virtual Dictionary<string, string> GetFieldAttributes()
        {
            ...
            dic.Add(nameof(BaseMachineLossResponseModel.EnableFlag), typeof(bool).ToString());

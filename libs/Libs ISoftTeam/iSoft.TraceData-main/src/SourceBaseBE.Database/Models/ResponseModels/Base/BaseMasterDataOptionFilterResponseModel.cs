...
{
    public class BaseMasterDataOptionFilterResponseModel : BaseCRUDResponseModel<MasterDataOptionFilterEntity>
    {
        
        
        public override object SetData(MasterDataOptionFilterEntity entity)
        {
            base.SetData(entity);
        ...
        public override List<object> SetData(List<MasterDataOptionFilterEntity> listEntity)
        {
            List<Object> listRS = new List<object>();
            foreach (MasterDataOptionFilterEntity entity in listEntity)
            {
                listRS.Add(new BaseMasterDataOptionFilterResponseModel().SetData(entity));
            }
            return listRS;
        }
        public IQueryable<MasterDataOptionFilterEntity> PrepareWhereQueryFilter(
            IQueryable<MasterDataOptionFilterEntity> query,
        ...
        public IQueryable<MasterDataOptionFilterEntity> PrepareQuerySort(
            IQueryable<MasterDataOptionFilterEntity> query,
        ...
        public IQueryable<MasterDataOptionFilterEntity> PrepareWhereQuerySearch(
            IQueryable<MasterDataOptionFilterEntity> query,
            ...
            Type responseType)
        {
            ...
            var predicate = LinqKit.PredicateBuilder.New<MasterDataOptionFilterEntity>(true);
        ...
        public virtual ExpressionStarter<MasterDataOptionFilterEntity> GetPredicate(ExpressionStarter<MasterDataOptionFilterEntity> predicate, string inputFieldKey, string searchValue)
        {
            if (inputFieldKey == nameof(BaseMasterDataOptionFilterResponseModel.Id))
            {
                predicate = predicate.Or(x => EF.Functions.Unaccent(x.Id.ToString().ToLower()).Contains(EF.Functions.Unaccent($"{searchValue.ToLower()}")));
            }
            else if (inputFieldKey == nameof(BaseMasterDataOptionFilterResponseModel.Order))
            {
        ...
        public virtual List<ColumnResponseModel> GetColumnAttribute()
        {
            ...
            columns.Add(new ColumnResponseModel(
                nameof(BaseMasterDataOptionFilterResponseModel.Id),
                nameof(BaseMasterDataOptionFilterResponseModel.Id),
                true, true, true
                ));

...
{
    public class BaseShiftResponseModel : BaseCRUDResponseModel<ShiftEntity>
    {
        ...
        public virtual EnumShiftType? ShiftType { get; set; }
        public virtual long? LineId { get; set; }
        public virtual LineEntity? ItemLine { get; set; }
        
        public override object SetData(ShiftEntity entity)
        {
            base.SetData(entity);
            ...
            this.ShiftType = entity.ShiftType;
            this.LineId = entity.LineId;
            this.ItemLine = entity.ItemLine;
        
            return this;
        }
        public override List<object> SetData(List<ShiftEntity> listEntity)
        {
            List<Object> listRS = new List<object>();
            foreach (ShiftEntity entity in listEntity)
            {
                listRS.Add(new BaseShiftResponseModel().SetData(entity));
            }
            return listRS;
        }
        public IQueryable<ShiftEntity> PrepareWhereQueryFilter(
        ...
        public IQueryable<ShiftEntity> PrepareQuerySort(
            IQueryable<ShiftEntity> query,
        ...
        public IQueryable<ShiftEntity> PrepareWhereQuerySearch(
            IQueryable<ShiftEntity> query,
            ...
            Type responseType)
        {
            ...
            var predicate = LinqKit.PredicateBuilder.New<ShiftEntity>(true);
        ...
        public virtual ExpressionStarter<ShiftEntity> GetPredicate(ExpressionStarter<ShiftEntity> predicate, string inputFieldKey, string searchValue)
        {
            if (inputFieldKey == nameof(BaseShiftResponseModel.Id))
            {
                predicate = predicate.Or(x => EF.Functions.Unaccent(x.Id.ToString().ToLower()).Contains(EF.Functions.Unaccent($"{searchValue.ToLower()}")));
            }
            else if (inputFieldKey == nameof(BaseShiftResponseModel.Order))
            {
        ...
        public virtual List<ColumnResponseModel> GetColumnAttribute()
        {
            ...
            columns.Add(new ColumnResponseModel(
                nameof(BaseShiftResponseModel.Id),
                nameof(BaseShiftResponseModel.Id),
                true, true, true
                ));

...
{
    public class BaseUserGroupResponseModel : BaseCRUDResponseModel<UserGroupEntity>
    {
        ...
        public override object SetData(UserGroupEntity entity)
        {
            base.SetData(entity);
        ...
        public override List<object> SetData(List<UserGroupEntity> listEntity)
        {
            List<Object> listRS = new List<object>();
            foreach (UserGroupEntity entity in listEntity)
            {
                listRS.Add(new BaseUserGroupResponseModel().SetData(entity));
            }
            return listRS;
        }
        public IQueryable<UserGroupEntity> PrepareWhereQueryFilter(
        ...
        public IQueryable<UserGroupEntity> PrepareQuerySort(
            IQueryable<UserGroupEntity> query,
        ...
        public IQueryable<UserGroupEntity> PrepareWhereQuerySearch(
            IQueryable<UserGroupEntity> query,
            ...
            Type responseType)
        {
            ...
            var predicate = LinqKit.PredicateBuilder.New<UserGroupEntity>(true);
        ...
        public virtual ExpressionStarter<UserGroupEntity> GetPredicate(ExpressionStarter<UserGroupEntity> predicate, string inputFieldKey, string searchValue)
        {
            if (inputFieldKey == nameof(BaseUserGroupResponseModel.Id))
            {
                predicate = predicate.Or(x => EF.Functions.Unaccent(x.Id.ToString().ToLower()).Contains(EF.Functions.Unaccent($"{searchValue.ToLower()}")));
            }
            else if (inputFieldKey == nameof(BaseUserGroupResponseModel.Order))
            {
        ...
        public virtual Dictionary<string, string> GetFieldAttributes()
        {
            ...
            dic.Add(nameof(BaseUserGroupResponseModel.Name), typeof(string).ToString());
        ...
        public virtual List<ColumnResponseModel> GetColumnAttribute()
        {
            ...
            columns.Add(new ColumnResponseModel(
                nameof(BaseUserGroupResponseModel.Id),
                nameof(BaseUserGroupResponseModel.Id),
                true, true, true
                ));

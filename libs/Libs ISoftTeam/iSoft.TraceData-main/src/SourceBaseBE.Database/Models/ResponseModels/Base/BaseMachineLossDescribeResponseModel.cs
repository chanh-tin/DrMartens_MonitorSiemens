...
{
    public class BaseMachineLossDescribeResponseModel : BaseCRUDResponseModel<MachineLossDescribeEntity>
    {
        ...
        public override object SetData(MachineLossDescribeEntity entity)
        {
            base.SetData(entity);
        ...
        public override List<object> SetData(List<MachineLossDescribeEntity> listEntity)
        {
            List<Object> listRS = new List<object>();
            foreach (MachineLossDescribeEntity entity in listEntity)
            {
                listRS.Add(new BaseMachineLossDescribeResponseModel().SetData(entity));
            }
            return listRS;
        }
        public IQueryable<MachineLossDescribeEntity> PrepareWhereQueryFilter(
            IQueryable<MachineLossDescribeEntity> query,
        ...
        public IQueryable<MachineLossDescribeEntity> PrepareQuerySort(
            IQueryable<MachineLossDescribeEntity> query,
        ...
        public IQueryable<MachineLossDescribeEntity> PrepareWhereQuerySearch(
            IQueryable<MachineLossDescribeEntity> query,
            ...
            Type responseType)
        {
            ...
            var predicate = LinqKit.PredicateBuilder.New<MachineLossDescribeEntity>(true);
        ...
        public virtual ExpressionStarter<MachineLossDescribeEntity> GetPredicate(ExpressionStarter<MachineLossDescribeEntity> predicate, string inputFieldKey, string searchValue)
        {
            if (inputFieldKey == nameof(BaseMachineLossDescribeResponseModel.Id))
            {
                predicate = predicate.Or(x => EF.Functions.Unaccent(x.Id.ToString().ToLower()).Contains(EF.Functions.Unaccent($"{searchValue.ToLower()}")));
            }
            else if (inputFieldKey == nameof(BaseMachineLossDescribeResponseModel.Order))
            {
        ...
        public virtual List<ColumnResponseModel> GetColumnAttribute()
        {
            ...
            columns.Add(new ColumnResponseModel(
                nameof(BaseMachineLossDescribeResponseModel.Id),
                nameof(BaseMachineLossDescribeResponseModel.Id),
                true, true, true
                ));

...
{
    public class BaseTranslateLanguageRequestModel : BaseCRUDRequestModel<TranslateLanguageEntity>
    {
        ...
        public override TranslateLanguageEntity GetEntity(TranslateLanguageEntity entity)
        {

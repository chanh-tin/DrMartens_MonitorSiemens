...
{
    public class BaseShiftRequestModel : BaseCRUDRequestModel<ShiftEntity>
    {
        ...
        public override ShiftEntity GetEntity(ShiftEntity entity)
        {
            ...
            if (this.ShiftType != null) entity.ShiftType = this.ShiftType;

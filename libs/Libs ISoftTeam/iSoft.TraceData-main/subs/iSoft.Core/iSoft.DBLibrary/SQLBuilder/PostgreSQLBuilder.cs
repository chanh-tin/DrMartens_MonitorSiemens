...
namespace iSoft.DBLibrary.SQLBuilder
{
  ...
  {
    private static PostgreSQLBuilder instance = null;
    public static PostgreSQLBuilder GetInstance()
    {
      if (instance == null)
      {
        instance = new PostgreSQLBuilder();
        instance.databaseType = EnumDBProvider.Postgres;
      }
      return instance;
    }
    public override string GetSQL()
    {
      return $"{delete}{update}{insert}{values}{sets}{select}{from}{where}{groupBy}{having}{orderBy}{limit}{offset}";
    }
    ...
    public override ISQLBuilder Delete(object table)
    {
      if (delete == "")
      {
        delete = "\n DELETE FROM ";

...
namespace iSoft.ConnectionCommon.MessageQueueNS
{
  public class QueueProperties
  {
    ...
    public QueueProperties SetRetryQueue(int timeRetryInSeconds = 60, int maxRetryCount = 200, ushort rabbitPrefetchCount = 8, bool durable = true, long maxMessageCount = 1000000)
    {

...
{
    [ApiController]
    [Route("api/v1/BaseExample001")]
    public class BaseExample001Controller : BaseCRUDController<Example001Entity, Example001RequestModel, Example001ResponseModel>
    {
        protected BaseExample001Service _serviceBase;
        public BaseExample001Controller(BaseExample001Service service, ILogger<BaseExample001Controller> logger)
          : base(service, logger)
        {
            _serviceCRUD = service;
            _serviceBase = (BaseExample001Service)_serviceCRUD;
        }

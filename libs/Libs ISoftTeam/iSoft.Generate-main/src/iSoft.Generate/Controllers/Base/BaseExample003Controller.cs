...
{
    [ApiController]
    [Route("api/v1/BaseExample003")]
    public class BaseExample003Controller : BaseCRUDController<Example003Entity, Example003RequestModel, Example003ResponseModel>
    {
        protected BaseExample003Service _serviceBase;
        public BaseExample003Controller(BaseExample003Service service, ILogger<BaseExample003Controller> logger)
          : base(service, logger)
        {
            _serviceCRUD = service;
            _serviceBase = (BaseExample003Service)_serviceCRUD;
        }

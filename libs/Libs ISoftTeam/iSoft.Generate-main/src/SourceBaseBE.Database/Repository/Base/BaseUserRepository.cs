...
{
    public class BaseUserRepository : BaseCRUDRepository<UserEntity>
    {
        public BaseUserRepository(CommonDBContext dbContext)
            : base(dbContext)
        {
        }
        ...
        {
            return nameof(BaseUserRepository);
        }
        ...
        public override UserEntity? GetById(long id, bool isTracking = false)
        {
            try
            {
                ...
                queryable = queryable
                      .Include(entity => entity.ItemLanguage)
                      .Include(entity => entity.ItemCountry)
                ...
                if (!isTracking)
                {
                    queryable = queryable.Select(entity => new UserEntity()
                    {
                        ...
                        ItemLanguage = entity.ItemLanguage,
                        CountryId = entity.CountryId,
                        ItemCountry = entity.ItemCountry,
                        Role = entity.Role,
        ...
        public override List<UserEntity> GetList(PagingRequestModel pagingReq = null, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                ...
                {
                    result = this.GetRedisData<List<UserEntity>>(cacheKey, null);
                }
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public (List<UserEntity> listUser, long totalRecord) GetListFilter(
            ...
            bool isTracking = false)
        {
            try
            {
                ...
                if (!isDirect && !isTracking)
                {
                    (result, totalRecord) = this.GetRedisData<(List<UserEntity>, long)>(cacheKey, (null, 0));
                }
                ...
                if (result == null)
                {
                    var dataSet = _context.Set<UserEntity>();
                    IQueryable<UserEntity> queryable;
                    IQueryable<UserEntity> queryableCountTotal;
                    if (!isTracking)
                    {
                        queryable = dataSet.AsNoTracking().AsQueryable();
                    }
                    ...
                    var responseModel = new BaseUserResponseModel();
        ...
        public override List<UserEntity> GetListByListIds(List<long> Ids, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<UserEntity>? result = null;
        ...
        public void Upsert(UserEntity entity, List<ISoftProjectEntity> iSoftProjectChildren, List<PermissionEntity> permissionChildren, List<UserGroupEntity> userGroupChildren, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
                {
                    // Insert
                    Insert(entity, iSoftProjectChildren, permissionChildren, userGroupChildren, userId);
                }
                else
                {
                    // Update
                    Update(entity, iSoftProjectChildren, permissionChildren, userGroupChildren, userId);
                }
                return;
            }
            catch (Exception ex)
        ...
        public void Insert(UserEntity entity, List<ISoftProjectEntity> iSoftProjectChildren, List<PermissionEntity> permissionChildren, List<UserGroupEntity> userGroupChildren, long? userId = null)
        {
            try
            {
                if (entity.Id > 0)
        ...
        public void Update(UserEntity entity, List<ISoftProjectEntity> iSoftProjectChildren, List<PermissionEntity> permissionChildren, List<UserGroupEntity> userGroupChildren, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)

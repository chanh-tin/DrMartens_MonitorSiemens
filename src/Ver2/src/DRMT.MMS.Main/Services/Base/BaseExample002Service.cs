...
namespace SourceBaseBE.MainService.Services
{
    public class BaseExample002Service : BaseCRUDService<Example002Entity>
    {
            ...
            : base(dbContext, logger)
        {
            ...
            _repositoryCRUD = new BaseExample002Repository(dbContext);
        ...
        {
            return nameof(BaseExample002Service);
        }
            ...
            bool isTracking = false)
        {
            ...
            List<Example002ResponseModel> listItemResponse = new Example002ResponseModel().SetData(list).Cast<Example002ResponseModel>().ToList();

            //* get column language
            var columns = new Example002ResponseModel().GetColumnAttribute();

            this.TranslateData(columns, request.Lang, nameof(Example002Entity));
            ...
            )
        {
            ...
            var dicFieldName2Index = new Example002ResponseModel().GetColumnAttribute()
        ...
        public override int Delete(Example002Entity entity, long? userId = null, bool isSoftDelete = true)
        {
        ...
        /// <returns></returns>
        public virtual List<long> GetListIdChildren(Example002Entity entity, string childEntity)
        {
            switch (childEntity)
            {

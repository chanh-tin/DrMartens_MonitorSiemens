...
{
    [ApiController]
    [Route("api/v1/BaseExample001Trans")]
    public class BaseExample001TransController : BaseCRUDController<Example001TransEntity, Example001TransRequestModel, Example001TransResponseModel>
    {
        protected BaseExample001TransService _serviceBase;

        public BaseExample001TransController(
            BaseExample001TransService service,
            ILogger<BaseExample001TransController> logger
            )
          : base(service, logger)
        {
            _serviceCRUD = service;
            _serviceBase = (BaseExample001TransService)_serviceCRUD;
        }

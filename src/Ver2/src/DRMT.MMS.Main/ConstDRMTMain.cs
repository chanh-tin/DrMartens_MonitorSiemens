...
namespace SourceBaseBE.MainService
{
	public class ConstDRMTMain
	{
		public static class ConstPayloadField
		{
			...
			public static DateTime StartTimeShift1 = new DateTime(1900, 1, 1, 6, 0, 0, DateTimeKind.Utc);
			public static DateTime StartTimeShift2 = new DateTime(1900, 1, 1, 14, 0, 0, DateTimeKind.Utc);
			public static DateTime StartTimeShift3 = new DateTime(1900, 1, 1, 22, 0, 0, DateTimeKind.Utc);
		...
		public static string ConstOeeRuntimeModelKey = "OEE_RUNTIME_MODEL";
        public static string CACHEKEYFORSHIFT = "CACHEKEYFORSHIFT";
        public static long ConstChartOeeDelayInMiliseconds = 1000;
    }
}

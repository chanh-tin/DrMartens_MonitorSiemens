...
(function(root, factory) {
	...
	elFinder.prototype.i18.vi = {
		...
		messages   : {
			...
			'cmdpreference': 'Thiết lập', // from v2.1.27 added 03.08.2017
			...
			'cmdhide': 'Ẩn (Thiết lập)', // from v2.1.41 added 24.7.2018
			...
			'btnRenameAll': 'Đổi tên(All)', // from v2.1.24 added 6.4.2017
			'btnPrevious' : 'Phía sau ($1/$2)', // from v2.1.24 added 11.5.2017
			'btnNext': 'Kế tiếp ($1/$2)', // from v2.1.24 added 11.5.2017
			'btnSaveAs'   : 'Lưu tại', // from v2.1.25 added 24.5.2017
			...
			'confirmRm'       : 'Bạn có chắc chắn muốn xóa vĩnh viễn các mục?<br/>  Sau khi thực hiện không thể phục hồi lại!',

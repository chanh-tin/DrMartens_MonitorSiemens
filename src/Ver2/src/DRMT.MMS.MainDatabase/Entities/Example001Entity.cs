...
namespace SourceBaseBE.Database.Entities
{
    ...
    public class Example001Entity : BaseCRUDEntity
    {
        ...
        [JsonIgnore]
        [StringLength(255)]
        [FormDataTypeAttributeText(EnumFormDataType.Password, maxLen: 50, isRequired: true, validationRules: new EnumValidationRules[] { EnumValidationRules.Confirmation })]
        ...
        public string? TimeOnlyData { get; set; }
        ...
        [NotMapped]
        public List<long>? Example001TransIds { get; set; } = new List<long>();
        [ListEntityAttribute(nameof(Example001TransEntity), nameof(Example001TransIds), EnumAttributeRelationshipType.One2Many)]
        public List<Example001TransEntity>? ListExample001Trans { get; set; } = new();
    }
}

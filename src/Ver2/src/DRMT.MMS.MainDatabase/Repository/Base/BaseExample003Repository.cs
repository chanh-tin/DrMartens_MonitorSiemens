...
{
    public class BaseExample003Repository : BaseCRUDRepository<Example003Entity>
    {
        public BaseExample003Repository(CommonDBContext dbContext)
            : base(dbContext)
        {
        }
        public override string TableName
        {
            get { return "I_Example003s"; }
        }
        public override string GetRepositoryName()
        {
            return nameof(BaseExample003Repository);
        }
        public override object GetDisplayField(Example003Entity entity)
        {
            return entity.Name;
        ...
        public override Example003Entity? GetById(long id, bool isTracking = false)
        {
            try
            {
                Example003Entity? result = null;
                var dataSet = _context.Set<Example003Entity>();
                IQueryable<Example003Entity> queryable;
                if (!isTracking)
                {
                ...
                //queryable = queryable.Select(entity => new Example003Entity()
                //{
                //    Id = entity.Id,
                //    Order = entity.Order,
...
//                         ListExample001 = entity.ListExample001 == null ? null : entity.ListExample001.Where(x => x.DeletedFlag != true).ToList(),
        ...
        public override List<Example003Entity> GetList(PagingRequestModel pagingReq = null, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<Example003Entity>? result = null;
                ...
                {
                    result = this.GetRedisData<List<Example003Entity>>(cacheKey, null);
                }
...
//                             ListExample001 = entity.ListExample001 == null ? null : entity.ListExample001.Where(x => x.DeletedFlag != true).ToList(),
        ...
        /// <returns></returns>
        /// <exception cref="DBException"></exception>
        public virtual (List<Example003Entity> listExample003, long totalRecord) GetListFilter(
            ...
            bool isTracking = false)
        {
            try
            {
                ...
                if (!isDirect && !isTracking)
                {
                    (result, totalRecord) = this.GetRedisData<(List<Example003Entity>, long)>(cacheKey, (null, 0));
                }
                ...
                if (result == null)
                {
                    var dataSet = _context.Set<Example003Entity>();
                    IQueryable<Example003Entity> queryable;
                    IQueryable<Example003Entity> queryableCountTotal;
                    if (!isTracking)
                    {
                        queryable = dataSet.AsNoTracking().AsQueryable();
                    }
                    ...
                    var responseModel = new Example003ResponseModel();
...
//                             ListExample001 = entity.ListExample001 == null ? null : entity.ListExample001.Where(x => x.DeletedFlag != true).ToList(),
        ...
        public override List<Example003Entity> GetListByListIds(List<long> Ids, bool isDirect = false, bool isTracking = false)
        {
            try
            {
                List<Example003Entity>? result = null;
...
//                             ListExample001 = entity.ListExample001 == null ? null : entity.ListExample001.Where(x => x.DeletedFlag != true).ToList(),
        ...
        public void Upsert(Example003Entity entity, List<Example001Entity> example001Children, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
        ...
        public void Insert(Example003Entity entity, List<Example001Entity> example001Children, long? userId = null)
        {
            try
            {
                if (entity.Id > 0)
                ...
                else
                {
                    ...
                    _context.Set<Example003Entity>().Add(entity);
                }
        ...
        public void Update(Example003Entity entity, List<Example001Entity> example001Children, long? userId = null)
        {
            try
            {
                if (entity.Id <= 0)
                ...
                else
                {
                    ...
                    _context.Set<Example003Entity>().Update(entity);
                }
                var result = _context.SaveChanges();
                ClearCachedData();
                return;
